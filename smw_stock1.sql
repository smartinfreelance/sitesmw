...
-- Volcando estructura de base de datos para smw_stock
CREATE DATABASE IF NOT EXISTS `smw_stock` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `smw_stock`;


-- Volcando estructura para tabla smw_stock.categorias
...
-- Volcando datos para la tabla smw_stock.categorias: ~6 rows (aproximadamente)
...
INSERT INTO `categorias` (`id`, `nombre`, `estado`, `fecha_alta`) VALUES
	...
	(7, 'NewCategoria', 1, '2015-04-27 04:57:56');
/*!40000 ALTER TABLE `categorias` ENABLE KEYS */;


-- Volcando estructura para tabla smw_stock.productos
...
-- Volcando datos para la tabla smw_stock.productos: ~12 rows (aproximadamente)
DELETE FROM `productos`;
/*!40000 ALTER TABLE `productos` DISABLE KEYS */;
INSERT INTO `productos` (`id`, `nombre`, `id_categoria`, `precio`, `stock`, `stock_min`, `stock_max`, `estado`, `fecha_alta`) VALUES
	(1, 'Arroz Ala 1Kilogramo', 1, 8.5, 30, 10, 100, 0, '2015-04-24 23:51:44'),
	...
	(13, 'Sal gruesa 1kg', 1, 12.5, 11, 12, 25, 0, '2015-04-26 22:49:48'),
	(14, 'Sal fina 200grms', 1, 13.25, 16, 12, 25, 0, '2015-04-26 23:09:09'),
	(15, 'Secador Brote de luz', 3, 12.25, 12, 10, 90, 0, '2015-04-27 01:54:32'),
	(16, 'Prod a Borrar 2KG', 3, 12.34, 65, 35, 150, 1, '2015-04-27 02:38:48');
/*!40000 ALTER TABLE `productos` ENABLE KEYS */;


-- Volcando estructura para tabla smw_stock.roles
...
-- Volcando datos para la tabla smw_stock.roles: ~6 rows (aproximadamente)
DELETE FROM `roles`;
...
INSERT INTO `roles` (`id`, `nombre`, `estado`, `fecha_alta`) VALUES
	...
	(7, 'NewRol', 1, '2015-04-27 04:37:11');
/*!40000 ALTER TABLE `roles` ENABLE KEYS */;


-- Volcando estructura para tabla smw_stock.usuarios
...
-- Volcando datos para la tabla smw_stock.usuarios: ~12 rows (aproximadamente)
