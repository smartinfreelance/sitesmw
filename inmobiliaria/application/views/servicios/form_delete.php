<div id = "main-content">
	<div class = "container">
		<ul class="breadcrumb">
  			...
  			<li class="active">Eliminar Servicio</li>
		</ul>
		<?php echo validation_errors(); ?>
		<?php echo form_open('servicios/deleteServicio'); ?>
		<input type="hidden" id = "id_servicio" name="id_servicio" value="<?php echo $servicio->id; ?>">
		<br/>
