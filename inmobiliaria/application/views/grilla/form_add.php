		...
		<div class="widget-content">
			<div class="nonboxy-widget">
				...
				<div class="control-group">
					...
					<div class="controls">
						<div>
							<input type="text" class="span2" placeholder = "Calle" id="calle" name ="calle" value = "" maxlength= "50">
				...
				<div class="control-group">
					...
					<div class="controls">
						<div>
							...
							?>
								<label><input type = "checkbox" id = "ambientes[]" name = "ambientes[]" value = "<?php echo $a->id; ?>" /> <?php echo $a->nombre; ?></label>
							<?php
								}
							?>
				...
				<div class="control-group">
					...
					<div class="controls">
						<div>
							...
							?>
								<label><input type = "checkbox" id = "instalaciones[]" name = "instalaciones[]" value = "<?php echo $i->id; ?>" /> <?php echo $i->nombre; ?></label>
							<?php
								}
							?>
				...
				<div class="control-group">
					...
					<div class="controls">
						<div>
							...
							?>
								<label><input type = "checkbox" id = "servicios[]" name = "servicios[]" value = "<?php echo $s->id; ?>" /> <?php echo $s->nombre; ?></label>
							<?php
								}
							?>
				...
				<div class="control-group">
					...
					<div class="controls">
						<div>
							Cubierta: <input type="text" class="span1" placeholder = "0" id="superficie_cubierta" name ="superficie_cubierta" value = "" maxlength= "4">m2 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							Descubierta: <input type="text" class="span1" placeholder = "0" id="superficie_descubierta" name ="superficie_descubierta" value = "" maxlength= "4"> m2
						</div>
					</div>
				</div>
				<div class="control-group">
