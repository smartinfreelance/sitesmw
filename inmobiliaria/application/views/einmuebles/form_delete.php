<div id = "main-content">
	<div class = "container">
		<ul class="breadcrumb">
  			<li><?php echo anchor('einmuebles' , 'EInmuebles');?><span class="divider">&raquo;</span></li>
  			<li class="active">Eliminar Estado de Inmueble</li>
		</ul>
		<?php echo validation_errors(); ?>
		<?php echo form_open('einmuebles/deleteTInmueble'); ?>
		<input type="hidden" id = "id_tinmueble" name="id_tinmueble" value="<?php echo $tinmueble->id; ?>">
		<br/>
		<div class="widget-content">
			<div class="nonboxy-widget">
				<div class="widget-head">
					<h5>¿Desea eliminar Estado de Inmueble?</h5>
				</div>
