		...
		<div class="widget-content">
			<div class="nonboxy-widget">
				...
				<div class="control-group">
					...
					<div class="control">
						<div>
							<input type="text" class="input-xlarge" id="usuario" name ="usuario" value = "<?php echo populateText(set_value('usuario'),''); ?>" maxlength="50">
						</div>
					</div>
				</div>
				<div class="control-group">
				...
				<div class="control-group">
					...
					<div class="control">
						<div>
							<input type="text" class="input-xlarge" id="apellido" name ="apellido" value = "<?php echo populateText(set_value('apellido'),''); ?>" maxlength="50">
						</div>
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls">
						<select id = "id_rol" name = "id_rol" >
							<option value = "" <?php echo populateSelect(set_value('id_rol'),'',''); ?>>Seleccione</option>
						<?php
							foreach($roles as $r){
								if($r->id > 1){
						?>
							<option value = "<?php echo $r->id?>" <?php echo populateSelect(set_value('id_rol'),'',$r->id); ?> ><?php echo $r->nombre; ?></option>
						<?php
								}
							}
						?>
				...
				<div class="control-group">
					...
					<div class="control">
						<div>
							<input type="text" class="input-xlarge" id="mail" name ="mail"  value = "<?php echo populateText(set_value('mail'),''); ?>" maxlength="50">
						</div>
					</div>
				</div>
