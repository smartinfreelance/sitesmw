	...
	<div class="full-width-container block-2 parallax-block" data-stellar-background-ratio="0.5">
		<div class="container">
			<div class="row">
				...
				<div class="grid_3">
					<article>
						<div class="img_container"><img src="<?php echo base_url(); ?>images/index-1_img-2.jpg" alt="our team"></div>
						<h4>Mark Gret</h4>
				...
				<div class="grid_3">
					<article>
						<div class="img_container"><img src="<?php echo base_url(); ?>images/index-1_img-3.jpg" alt="our team"></div>
						<h4>Irma Anderson</h4>
						<p>Lamus at magna non derto merli seworet gertomin</p>
					</article>
				</div>
				<div class="grid_3">
					<article>
						<div class="img_container"><img src="<?php echo base_url(); ?>images/index-1_img-4.jpg" alt="our team"></div>
						<h4>Sam Wood</h4>
						<p>Lamus at magna non derto merli seworet gertomin</p>
					</article>
				</div>
				<div class="grid_3">
					<article>
						<div class="img_container"><img src="<?php echo base_url(); ?>images/index-1_img-5.jpg" alt="our team"></div>
						<h4>Kevin Thomson</h4>
						<p>Lamus at magna non derto merli seworet gertomin</p>
					</article>
				</div>
